...
def get_queue() -> JobQueue:
    ...
    with _lock:
        ...
        if backend == "pubsub":
            from agentx.subsystems.sentinel_x.queue.pubsub_queue import PubSubQueue

            queue: JobQueue = PubSubQueue()
        elif backend == "eventbridge":
            from agentx.subsystems.sentinel_x.queue.eventbridge_queue import EventBridgeQueue
